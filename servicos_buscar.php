...
$busca = $_GET['buscar'];
$listaBusca = $conn->query("select * from vw_servicos where nome like '%$busca%' or detalhe like '%$busca%'");
    ...
    <div class="container">
        ...
        <?php if($numLinhas == 0){ ?>
            <h2 class="breadcrumb alert-danger">
                ...
                Não há serviços relacionados com a <strong> <?php echo $busca ?></strong>
            </h2>
        <?php }?>
        ...
        <?php if($numLinhas>0){?>
            <h2 class="breadcrumb alert-danger">
                ...
                <strong> Busca por "<?php echo $busca;?>"</strong>
            </h2>
            <div class="row">
                <?php do{ ?>
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption text-right">
                                <h3 class="text-danger">
                                    <strong><?php echo $rowBusca['nome']?></strong>
                                </h3>
                                <p class="text-left">
                                   <?php echo mb_strimwidth($rowBusca['categoria_descricao'],0,42,'...'); ?>
                                </p>
 
                                <p class="text-left">
                                   <?php echo mb_strimwidth($rowBusca['detalhe'],0,42,'...'); ?>
                                </p>
                                <p>
